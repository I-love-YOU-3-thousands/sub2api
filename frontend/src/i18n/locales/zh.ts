export default {
  ...
  imageStudio: {
    title: '在线生图',
    description: '创建文生图和图生图任务，并异步查看缓存结果',
    key: '密钥',
    selectKey: '选择 OpenAI 密钥',
    noKeys: '暂无可用 OpenAI 生图密钥',
    goToKeys: '去创建密钥',
    model: '模型',
    prompt: '提示词',
    optimizePrompt: '优化提示词',
    optimizingPrompt: '优化中...',
    promptOptimizationTitle: '使用优化后的提示词吗？',
    useOptimizedPrompt: '使用',
    regeneratePrompt: '换一个',
    ...
    refresh: '刷新',
    history: '历史记录',
    historySubtitle: '任务会在后台生成，完成后自动展示缓存图片',
    empty: '暂无生成记录',
    progress: '进度',
    viewOriginal: '查看',
    download: '下载',
    ...
    submitFailed: '创建生图任务失败',
    created: '已创建生图任务',
    deleted: '任务已删除',
    selectKeyFirst: '请选择密钥',
    promptRequired: '请输入提示词',
    referenceRequired: '请上传参考图',
    modes: {
      textToImage: '文生图',
      imageToImage: '图生图'
    },
