export default {
  ...
  imageStudio: {
    title: 'Image Studio',
    description: 'Create text-to-image and image-to-image tasks, then view cached results asynchronously',
    key: 'Key',
    selectKey: 'Select OpenAI key',
    noKeys: 'No available OpenAI image key',
    goToKeys: 'Create key',
    model: 'Model',
    prompt: 'Prompt',
    optimizePrompt: 'Optimize',
    optimizingPrompt: 'Optimizing...',
    promptOptimizationTitle: 'Use the optimized prompt?',
    useOptimizedPrompt: 'Use',
    regeneratePrompt: 'Another',
    ...
    refresh: 'Refresh',
    history: 'History',
    historySubtitle: 'Tasks run in the background and cached images appear when ready',
    empty: 'No image tasks yet',
    progress: 'Progress',
    viewOriginal: 'View',
    download: 'Download',
    zoomIn: 'Zoom in',
    ...
    loadFailed: 'Failed to load image tasks',
    loadKeysFailed: 'Failed to load keys',
    submitFailed: 'Failed to create image task',
    created: 'Image task created',
    deleted: 'Task deleted',
    selectKeyFirst: 'Select a key first',
    promptRequired: 'Enter a prompt',
    referenceRequired: 'Upload a reference image',
    modes: {
